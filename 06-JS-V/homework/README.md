...
* `prototype`: son un mecanismo mediante el cual los objetos en JavaScript heredan características entre sí.
* _Constructors_ (de Clases): con funcuines, cuya tarea es la construccion de objetos.
