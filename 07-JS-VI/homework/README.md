...
* Funciones Callback: son funciones que se pasan a otra función como un argumento, que luego se invocan dentro de la función externa para completar algún tipo de rutina o acción.
